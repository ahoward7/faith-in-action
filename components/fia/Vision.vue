<template>
  <div class="w-full flex">
    <div class="bg-fia-yellow grow" />
    <fia-section class="bg-fia-yellow" style="max-width: 1600px">
      <div class="pb-10">
        <img src="~/assets/images/logos/fia-vision-text.png" class="fl max-h-24 3xl:max-h-32">
      </div>
