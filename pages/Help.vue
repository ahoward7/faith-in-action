<template>
  <page-max-1920 class="overflow-hidden">
    ...
    <page-text-wrapper>
      ...
      <fia-bullet :number="1">
        Our services are provided to the elderly living with special needs not already being served by other individuals
      ...
      <fia-bullet :number="3">
        Our volunteers do not handle or manage medications, or any medical services. Volunteers also should not receive
      ...
      <fia-bullet :number="5">
        ...
        morning of the appointment to verify information, i.e. pick up time, mobility, location of appointment, etc. The
      ...
      <page-text class="ml-0 md:ml-36">
        <fia-bullet>
          After counting money with recipient, have the recipient place the money in an envelope with the amount written
      ...
      <fia-bullet :number="7">
        Faith in Action's services are provided free of charge. When recipients try to pay you, you may suggest sending
